...
${OBJECTDIR}/CXIndex.o: CXIndex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CXIndex.o CXIndex.c

${OBJECTDIR}/CXTranslationUnit.o: CXTranslationUnit.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CXTranslationUnit.o CXTranslationUnit.c

${OBJECTDIR}/CXUnsavedFileList.o: CXUnsavedFileList.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CXUnsavedFileList.o CXUnsavedFileList.c

${OBJECTDIR}/nblibclang.o: nblibclang.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nblibclang.o nblibclang.c

${OBJECTDIR}/nblibclang.h.gch: nblibclang.h
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o "$@" nblibclang.h

${OBJECTDIR}/org_netbeans_modules_cnd_clang_jni_CXIndex.h.gch: org_netbeans_modules_cnd_clang_jni_CXIndex.h
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o "$@" org_netbeans_modules_cnd_clang_jni_CXIndex.h
...
${OBJECTDIR}/org_netbeans_modules_cnd_clang_jni_CXUnsavedFileList.h.gch: org_netbeans_modules_cnd_clang_jni_CXUnsavedFileList.h
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF "$@.d" -o "$@" org_netbeans_modules_cnd_clang_jni_CXUnsavedFileList.h
