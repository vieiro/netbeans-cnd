...
import org.netbeans.modules.cnd.script.lexer.MesonLanguageHierarchy;
import org.netbeans.modules.cnd.utils.MIMENames;

/**
 * Meson script tokens.
 */
public enum MesonTokenId implements TokenId {
    /**
    ...
    private MesonTokenId(String category) {
    ...
    private static final Language<MesonTokenId> LANGUAGE =
        new MesonLanguageHierarchy(MIMENames.MESON_MIME_TYPE).language();

    public static Language<MesonTokenId> language() {
        return LANGUAGE;
    }
}